        		...
        		<form class="form" method="post">
        			...
        			<div class="card card-underline">
        				<div class="card-head card-head-lg">
							<header>Sửa thông tin đợt thực tập trong năm học</header>
							<div class="tools">
								<div class="btn-group">
        				...
        				<div class="card-body">
        					<div class="row">
        						<div class="col-sm-12">
        							<div class="form-group form-group @if($errors->has('year')) has-error @endif">
        								<input class="form-control" id="year" name="year" type="text" value="{{old('year')?old('year'):$year->year}}">
        						...
        						<div class="col-sm-12">
    								<div class="form-group form-group @if($errors->has('startdate')) has-error @endif">
										<div class="input-group date" id="demo-date-format">
											<div class="input-group-content">
												<input class="form-control" type="text" name="startdate" id="startdate" value="{{old('startdate')?old('startdate'):date('d/m/Y',strtotime($year->startdate))}}">
    							...
    							<div class="col-sm-12">
        							<div class="form-group ">
    									<textarea aria-required="true" name="note" id="note" class="form-control" rows="3" >{{old('note')?old('note'):$year->note}}</textarea>
