...
<section>
    <div class="section-body contain-lg">
        <!-- BEGIN INTRO -->
    		<div class="row">
    			<div class="col-lg-12">
    				<h1 class="text-primary">Thêm tiến độ thực tập</h1>
    			</div><!--end .col -->
    		</div><!--end .row -->
    	<!-- END INTRO -->
    	<div class="row">
        			...
        			<div class="card">
        				<div class="card-body floating-label">
        					<div class="row">
    							...
    							<div class="col-sm-6">
        							<div class="form-group">
    									<textarea aria-required="true" name="description" id="description" class="form-control" rows="3" required=""></textarea>
    									<label for="description">Mô tả:</label>
    								</div>
        						</div>
        						<div class="col-sm-6">
        							<div class="form-group">
    									<textarea aria-required="true" name="content" class="form-control" rows="3" required=""></textarea>
    									<label for="content">Nội dung:</label>
    								</div>
        						</div>
    							<div class="col-sm-6">
        							<div class="form-group">
    									<textarea aria-required="true" name="note" id="note" class="form-control" rows="3" required=""></textarea>
    									<label for="note">Ghi chú:</label>
    								</div>
    							</div>
    							<div class="col-sm-6">
        							<div class="form-group">
    									<textarea aria-required="true" name="result" id="result" class="form-control" rows="3" required=""></textarea>
    									<label for="result">Kết quả:</label>
    								</div>
    							</div>
    							<div class="col-sm-6">
        							<div class="form-group">
        								<input class="form-control" id="complete" name="complete" type="checkbox" value="1">
