        					...
        					<div class="row">
        						<div class="col-sm-12">
        							<div class="form-group @if($errors->has('job_name')) has-error @endif">
        								<input class="form-control" id="job_name" name="job_name" type="text" value="{{old('job_name')}}">
        							...
        							<div class="form-group">
        								<select id="intertime_id" name="intertime_id" class="form-control">
        									@foreach($intership_time as $option)
                                                ...
                                                @else
                                                @if( $option->id ==  $intertime_id) selected @endif 
                                                @endif
                                                >{{$option->intertime_name}}</option>
        									@endforeach
										</select>
    							...
    							<div class="col-sm-6">
        							<div class="form-group @if($errors->has('location')) has-error @endif">
        								<input class="form-control" id="location" name="location" type="text" value="{{old('location')}}">
    							...
    							<div class="col-sm-6">
        							<div class="form-group @if($errors->has('description')) has-error @endif">
    									<textarea aria-required="true" name="description" class="form-control" rows="10" >{{old('description')}}</textarea>
        						...
        						<div class="col-sm-6">
        							<div class="form-group @if($errors->has('content')) has-error @endif">
    									<textarea aria-required="true" name="content" class="form-control" rows="10" >{{old('content')}}</textarea>
    							...
    							<div class="col-sm-6">
        							<div class="form-group">
        								<input class="form-control" id="important" name="important" type="checkbox" value="1">
        								<label for="important">Quan trọng:</label>
        							</div>
        						</div>
        						<div class="col-sm-6">
        							<div class="form-group">
        								<input class="form-control" id="allday" name="allday" type="checkbox" value="1">
        						...
        						<div class="col-sm-12">
        							<div class="form-group">
    									<textarea aria-required="true" name="note" id="note" class="form-control" >{{old('note')}}</textarea>
