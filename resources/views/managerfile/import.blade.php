		...
		<div class="row">
			...
			<div class="col-lg-8">
				<article class="margin-bottom-xxl">
					<p class="lead">Giao diện nhập dữ liệu lên hệ thống trong quản lý thực tập</p>
				</article>
			</div>
			<div class="col-lg-12">
				<div class="card">
					<div class="card-body "> 
						<form method="post" action="{{ route('managerfile::import') }}" class="form floating-label form-validation adminworkform" role="form" novalidate="novalidate" enctype="multipart/form-data">
