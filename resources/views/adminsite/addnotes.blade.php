...
<li>
	<a href="{{ route('site::getaddnotes')}}" style="color:blue;">Thêm thông báo</a>
</li>
@stop
@section('active_notes_add')
class="active"
@stop
...
<section>
	...
	<div class="row">
		...
		<div class="col-lg-offset-1 col-md-8">
			<form method="post" enctype="multipart/form-data" action="{{ route('site::postaddnotes') }}" class="form form-validate floating-label adminform" novalidate="novalidate">
				<input type="hidden" name="_token" value="<?php echo csrf_token();?>">
				<input type="hidden" name="state" value="1">
				<div class="card">
					<div class="card-body">
						<div class="form-group">
							<input type="text" class="form-control" id="title" name="title" data-rule-minlength="10" maxlength="255" required="" aria-required="true">
							<label for="title">Tên thông báo</label>
							<p class="help-block">Độ dài nhỏ nhất 10 / Độ dài lớn nhất 255</p>
						</div>
						<div class="form-group">
					...
					<div class="card-actionbar">
						<div class="card-actionbar-row">
							<a href="{{route('site::listnotes')}}"  class="btn btn-flat btn-primary ink-reaction">Hủy<a>
							<button type="submit" class="btn btn-flat btn-primary ink-reaction">Lưu</button>
						</div>
					</div>
				</div><!--end .card -->
				<em class="text-caption">Quản lý thông báo</em>
			</form>
		</div><!--end .col -->
	</div><!--end .row -->
