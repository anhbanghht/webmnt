...
<li>
	<a href="{{ route('site::getaddcategory')}}" style="color:blue;">Thêm thể loại</a>
</li>
@stop
@section('active_category_add')
class="active"
@stop
...
<section>
	...
	<div class="row">
		...
		<div class="col-lg-offset-1 col-md-8">
			<form method="post" action="{{ route('site::postaddcategory') }}" class="form form-validate floating-label adminform" novalidate="novalidate">
