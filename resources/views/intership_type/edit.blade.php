        		...
        		<form class="form" method="post" enctype="multipart/form-data">
        			...
        			<div class="card card-underline">
        				<div class="card-head card-head-lg">
							<header>Sửa thông tin loại thực tập</header>
							<div class="tools">
								<div class="btn-group">
        					...
        					<div class="row">
        						<div class="col-sm-6">
        							<div class="form-group @if($errors->has('intertype_name')) has-error @endif">
        								<input class="form-control" id="intertype_name" name="intertype_name" type="text" value="{{old('intertype_name')?old('intertype_name'):$intership_type->intertype_name}}">
        						...
        						<div class="col-sm-6">
        							<div class="form-group @if($errors->has('intertype_fullname')) has-error @endif">
        								<input class="form-control" id="intertype_fullname" name="intertype_fullname" type="text" value="{{old('intertype_fullname')?old('intertype_fullname'):$intership_type->intertype_fullname}}" >
        						...
        						<div class="col-sm-6">
        							<div class="form-group">
    									<textarea aria-required="true" name="description" id="description" class="form-control" rows="3" >{{old('description')?old('description'):$intership_type->description}}</textarea>
    									<label for="description">Mô tả:</label>
    								</div>
        						</div>
    							<div class="col-sm-6">
        							<div class="form-group">
    									<textarea aria-required="true" name="note" id="note" class="form-control" rows="3" >{{old('note')?old('note'):$intership_type->note}}</textarea>
    									<label for="note">Ghi chú</label>
    								</div>
    							</div>
    							<div class="col-sm-6">
        							<div class="form-group">
        								<input class="form-control" id="allow" name="allow" type="checkbox" value="1" @if($intership_type->allow) checked @endif>
