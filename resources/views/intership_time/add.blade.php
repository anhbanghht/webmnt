        		...
        		<form class="form" method="post">
        			...
        			<div class="card card-underline">
					    <div class="card-head card-head-lg">
							<header>Thêm thông tin đợt thực tập</header>
							<div class="tools">
								<div class="btn-group">
        					...
        					<div class="row">
        						<div class="col-sm-12">
        							<div class="form-group @if($errors->has('intertime_name')) has-error @endif">
        								<input class="form-control" id="intertime_name" name="intertime_name" type="text" value="{{old('intertime_name')}}">
                                        <label for="intertime_name">Tên đợt thực tập:</label>
        						...
        						<div class="col-sm-12">
        							<div class="form-group @if($errors->has('content')) has-error @endif">
    									<textarea aria-required="true" id="txt_content" name="content" class="form-control" rows="3" >{{old('content')}}</textarea>
