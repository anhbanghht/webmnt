...
<li>
	<a href="{{ route('site::listnotes')}}" style="color:blue;">Danh sách thông báo</a>
</li>
@stop
@section('active_notes_list')
class="active"
@stop
...
<section class="style-default-bright">
	<div class="section-header">
		<h2 class="text-primary">Quản Lý Thông báo</h2>
	</div>
	<div class="section-body">
						...
						<table id="datatable1" class="table table-striped table-hover">
							...
							<tbody>
								...
								<tr>
									...
									<td><?php echo $item->attached;?></td>
									<td><?php echo $item->created_at; ?></td>
									<td>
										<a href="{{route('site::geteditnotes',$item->id)}}" >
											<i class="fa fa-pencil"></i>
										</a>
									</td>
									<td>
										<a href="javascript:void(0)" onclick="DoanListView.DeleteItem('notes',<?php echo $item->id;?>)">
		...
		<!-- END DATATABLE 1 -->
		<div class="add-table">
			<a class="btn ink-reaction btn-primary" href="{{route('site::getaddnotes')}}"><span class="fa fa-plus"></span></a>
		</div>
		<hr class="ruler-xxl"/>
