...
<li>
	<a href="{{ route('site::geteditnotes',$item->id)}}" style="color:blue;">Sửa thông báo</a>
</li>
@stop
...
<section>
	...
	<div class="row">
		...
		<div class="col-lg-offset-1 col-md-8">
			<form method="post" enctype="multipart/form-data" action="{{ route('site::posteditnotes',$item->id) }}" class="form form-validate floating-label adminform" novalidate="novalidate">
				...
				<div class="card">
					<div class="card-body">
						...
						<div class="form-group">
							...
							<p class="help-block"><a href="{{url('uploads/attachs/'.$item->attached)}}"><?php echo $item->attached;?></a></p>
						</div>
					</div><!--end .card-body -->
