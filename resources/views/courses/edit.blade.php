        		...
        		<form class="form" method="post" enctype="multipart/form-data">
        			...
        			<div class="card card-underline">
        				<div class="card-head card-head-lg">
							<header>Sửa thông tin khóa học</header>
							<div class="tools">
								<div class="btn-group">
        					...
        					<div class="row">
        						<div class="col-sm-6">
        							<div class="form-group @if($errors->has('course')) has-error @endif">
        								<input class="form-control" id="course" name="course" type="text" value="{{old('course')?old('course'):$courses->course}}">
        						...
        						<div class="col-sm-6">
        							<div class="form-group @if($errors->has('course_full')) has-error @endif">
        								<input class="form-control" id="course_full" name="course_full" type="text" value="{{old('course_full')?old('course_full'):$courses->course_full}}">
    							...
    							<div class="col-sm-6">
        							<div class="form-group">
    									<textarea aria-required="true" name="note" id="note" class="form-control" rows="3" >{{old('note')?old('note'):$courses->note}}</textarea>
