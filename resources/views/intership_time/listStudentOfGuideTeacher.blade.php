        	...
        	<div class="col-lg-12">
    			<div class="card card-underline">
    			    <div class="card-head card-head-lg">
						<header>Quản lý đề tài trong đợt <span style="color: #311B92;font-weight: bold;">{{$intership_time->intertime_name}} của giáo viên {{$teacher->teacher_name}}</span></header>
					</div>
    				<div class="card-body">
                      ...
                      <th>STT</th>
                        ...
                        <td>{{$key+1}}</td>
      									...
      									<td>@if($item->topic){{$item->topic->topic_name}}@endif</td>
      									<td>
