                ...
                <form class="form" method="post" id="add-form">
                    ...
                    <div class="card card-underline">
                        <div class="card-head card-head-lg">
                            <header>Sửa thông tin đề tài</header>
                            <div class="tools">
                                <div class="btn-group">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group @if($errors->has('topic_name')) has-error @endif">
                                        ...
                                        <textarea aria-required="true" name="topic_name" id="topic_name" class="form-control" rows="1">{{old('topic_name')?old('topic_name'):$intertime_students->topics->topic_name}}</textarea>
        ...
        <div class="row">
           <div class="col-md-12">
                {{ csrf_field() }}
                    <div class="card card-underline">
                        <div class="card-head card-head-lg">
                            <header>Sửa thông tin đề cương</header>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group @if($errors->has('target')) has-error @endif">
                                        ...
                                        <textarea aria-required="true" name="target" id="target" class="form-control" rows="5" >{{old('target')?old('target'):$intertime_students->topics->target}}</textarea>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group @if($errors->has('content')) has-error @endif">
                                        ...
                                        <textarea aria-required="true" id="txt_content" name="content" class="form-control" rows="5" >{{old('content')?old('content'):$intertime_students->topics->content}}</textarea>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group @if($errors->has('expect_result')) has-error @endif">
                                        ...
                                        <textarea aria-required="true" name="expect_result" id="expect_result" class="form-control" rows="3" >{{old('expect_result')?old('expect_result'):$intertime_students->topics->expect_result}}</textarea>
                    ...
                    <div class="card card-underline">
                        ...
                        <div class="card-body">
                            ...
                            <table class="table no-margin" id="tiendo">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="hidden"><input type="hidden" name="ids[]" value="{{old('ids')[$key]}}" checked /></td>
                                        <td class='sub_startdate'>{{old('sub_startdate')[$key]}}</td>
                                        <td class='sub_enddate'>{{old('sub_enddate')[$key]}}</td>
                                        <td class='sub_description'>{{old('sub_description')[$key]}}</td>
                                        <td class='sub_content'>{{old('sub_content')[$key]}}</td>
                                        <td class='sub_result'>{{old('sub_result')[$key]}}</td>
                                        <td class='sub_note'>{{old('sub_note')[$key]}}</td>
                                        <td>
                                    ...
                                    @endforeach
                                    @else
                                    @foreach($intertime_students->topics->topic_process as $row)
                                    <tr>
                                        <td class="hidden"><input type="hidden" name="ids[]" value="{{$row->id}}" checked /></td>
                                        <td class='sub_startdate'>{{$row->sdate}}</td>
                                        <td class='sub_enddate'>{{$row->edate}}</td>
                                        <td class='sub_description'>{{$row->description}}</td>
                                        <td class='sub_content'>{{$row->content}}</td>
                                        <td class='sub_result'>{{$row->result}}</td>
                                        <td class='sub_note'>{{$row->note}}</td>
                                        <td>
                                            <a class="btn btn-icon-toggle btn-primary edit_row" href="#"  data-toggle="tooltip" data-placement="top" data-original-title="Sửa tiến độ đề tài"><i class="fa fa-pencil"></i></a>
                                            <a class="btn btn-icon-toggle btn-primary remove_row" href="#"  data-toggle="tooltip" data-placement="top" data-original-title="Xóa tiến độ đề tài"><i class="fa fa-trash"></i></a>
                                        </td>
                        ...
                        <div class="card-actionbar">
                            <div class="card-actionbar-row">
                                <button type="submit" class="btn ink-reaction btn-primary">Cập nhật đề tài</button>
                            </div>
                        </div>
                    </div><!--end .card -->
                </div>
...
<table id="clone" style="display:none">
    <tr>
        <td class="hidden"><input type="hidden" name="ids[]" value="" checked/></td>
