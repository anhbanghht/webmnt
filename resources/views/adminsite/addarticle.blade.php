...
<li>
	<a href="{{ route('site::getaddarticle')}}" style="color:blue;">Thêm bài viết</a>
</li>
@stop
@section('active_article_add')
class="active"
@stop
...
<section>
	...
	<div class="row">
		...
		<div class="col-lg-offset-1 col-md-8">
			<form method="post" action="{{ route('site::postaddarticle') }}" enctype="multipart/form-data" class="form adminform">
				...
				<div class="card">
					<div class="card-body">
						...
						<div class="form-group">
							<select id="categoryid" name="categoryid" class="form-control">
								<?php foreach($categorys as $cat): ?>
									<option value="<?php echo $cat->id; ?>"<?php if($cat->id==1): echo "selected"; endif;?>><?php echo $cat->title;?></option>
								<?php endforeach;?>
							</select>
						...
						<div class="form-group">
							<textarea id="ckeditor" name="content" class="form-control control-12-rows" placeholder="Enter text ..."></textarea>
